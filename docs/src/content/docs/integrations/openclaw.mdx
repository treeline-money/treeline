...
When you're ready to use your own financial data, set up a data source **outside of the chat** using the Treeline desktop app or CLI directly. This keeps your credentials (bank tokens, API keys) off the chat platform and LLM provider.
...
After connecting a data source, run `tl sync` (for bank sync) or import your CSV, and the skill will start querying your real data.
